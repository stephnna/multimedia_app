...
SECRET_KEY = env.str('SECRET_KEY', default='django-insecure-&wb65(=w%=h7dv$flb+60qi#0pjztl4x379)p=%qtq_sr6c(la')

# Read DEBUG from environment variable
DEBUG = env.bool('DEBUG', default=False)

# Read ALLOWED_HOSTS from environment variable
ALLOWED_HOSTS = ['multimedia-y9dq.onrender.com', '127.0.0.1']
...
MIDDLEWARE = [
    ...
    'multimedia_app.redirect_middleware.RedirectToSignupMiddleware',  # Custom middleware here
